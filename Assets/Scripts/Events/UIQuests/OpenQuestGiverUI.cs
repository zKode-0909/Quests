...
{
    public readonly List<QuestGiverQuestUIItem> questsToShow;
    ...
    public OpenQuestGiverUI(List<QuestGiverQuestUIItem> questsToShow,string giverName,string questerName,string questGiverID,string questerID,int level) {
